...
import { ShieldCheck, Settings as SettingsIcon, LogOut, Users, GraduationCap } from "lucide-react";
...
// 管理员专区：教师管理 / 学生管理 / 系统管理（仅 admin 可见）
const ADMIN_NAV: NavEntry[] = [
  {
    num: "07", key: "teachers", label: "教师管理", en: "Teachers",
    href: "/admin/teachers", icon: { kind: "lucide", component: Users as ComponentType<SVGProps<SVGSVGElement>> },
    matches: ["/admin/teachers"],
  },
  {
    num: "08", key: "students", label: "学生管理", en: "Students",
    href: "/admin/students", icon: { kind: "lucide", component: GraduationCap as ComponentType<SVGProps<SVGSVGElement>> },
    matches: ["/admin/students"],
  },
  {
    num: "09", key: "system", label: "系统管理", en: "System",
...
const SETTINGS_NAV: NavEntry = {
  num: "10", key: "settings", label: "个人设置", en: "Settings",
